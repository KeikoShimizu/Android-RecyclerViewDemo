...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    private String[] details = {"Item one detail","Item two detail","Item three detail","Item four detail"
    ,"Item five detail","Item six detail","Item seven detail","Item eight detail"};
